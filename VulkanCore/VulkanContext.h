...
public:
    ...
    // --- ÚJ: Textúra és Descriptor kezelés ---
    // Ezek a függvények már implementálva vannak a feltöltött VulkanContext.cpp-ben
    ...
    // Textúra segédfüggvények (publikusak, hogy a Texture osztály vagy a .cpp elérje őket)
